  ...
  registerSidebarTOC: function() {
    ...
    const sections = [...navItems].map(element => {
      ...
      link.addEventListener('click', event => {
        ...
        var target = document.getElementById(decodeURI(event.currentTarget.getAttribute('href').replace('#', '')));  // to fix toc bug
      ...
      return document.getElementById(decodeURI(link.getAttribute('href').replace('#', ''))); // to fix toc bug
    });
